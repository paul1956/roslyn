...
Namespace Microsoft.CodeAnalysis.VisualBasic.Symbols
    ...
    Friend Class SynthesizedMainTypeEntryPoint
        ...
        Friend Overrides Function GetBoundMethodBody(compilationState As TypeCompilationState, diagnostics As DiagnosticBag, <Out()> Optional ByRef methodBodyBinder As Binder = Nothing) As BoundBlock
            ...
            Return New BoundBlock(syntaxNode, compilationState.CompilationCheckOverflow, statementListSyntax:=Nothing, ImmutableArray(Of LocalSymbol).Empty, ImmutableArray.Create(statement, New BoundReturnStatement(syntaxNode, Nothing, Nothing, Nothing)))
        End Function
