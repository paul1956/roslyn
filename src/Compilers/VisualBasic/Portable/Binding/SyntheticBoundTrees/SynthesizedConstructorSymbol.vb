...
Namespace Microsoft.CodeAnalysis.VisualBasic.Symbols
    ...
    Partial Friend Class SynthesizedConstructorSymbol
        ...
        Friend Overrides Function GetBoundMethodBody(compilationState As TypeCompilationState, diagnostics As DiagnosticBag, Optional ByRef methodBodyBinder As Binder = Nothing) As BoundBlock
            ...
            Return New BoundBlock(Me.Syntax, Me.Syntax.RequireOverflowCheck(compilationState.CompilationCheckOverflow), statementListSyntax:=Nothing, ImmutableArray(Of LocalSymbol).Empty, ImmutableArray.Create(Of BoundStatement)(returnStmt))
        End Function
